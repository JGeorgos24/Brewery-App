    ...
    render(){
        ...
        return(
            <div className="BreweriesList">
                ...
                <p>Upvotes: {this.props.breweries.upvotes}</p>
                ...
                onClick={() => this.props.handleUp(this.props.brewId, this.props.upvoteState)} />
                <img className="small" src="https://www.clipartkey.com/mpngs/m/95-950756_hd-th-lets-upvote-transparent-background-red-down.png" 
                onClick={() => this.props.handleDown(this.props.brewId, this.props.downvoteState)} />
            </div>
        )
    }
}
